...
def lookupFor(typeCode):
    ...
    #return _fieldsRegistry[typeCode]     #original code
    return _fieldsRegistry[chr(typeCode)]  # fixbug ChiuPikS
...
def FindRecordsFromFile(a_fileName, a_searchFieldName, a_searchStringList ):
    ...
    bFoundRecords,foundRecords = read_dbf.FindRecords(a_searchFieldName,a_searchStringList)
    read_dbf.close()
    
    return bFoundRecords,foundRecords
#===================================================================================================
def ReplaceFilesInFileList(dbfFileList, searchField, searchList, replaceStr, replaceFieldList):
  foundfileList = []
  for vfile in dbfFileList :
      print (vfile)
      bFoundRecords,foundRecords = FindRecordsFromFile(vfile,searchField,searchList)
      if bFoundRecords :
...
if (__name__=='__main__'):
    ...
    #copyDBF("county.dbf","countyCopy.dbf")
    #test_dbf_class()
    #demoCreate(_name)
    #demoRead(_name)
    #test_FindRecords()
